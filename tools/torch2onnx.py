...
def parse_args():
    ...
    parser.add_argument('--deploy_cfg',
                        default=r'../configs/mmseg/segmentation_onnxruntime_static-512x512.py',
                        help='deploy config path')
    parser.add_argument('--model_cfg',
                        default='../GuoWangTong512_build_20221031/upernet_hornet_large_gf_512_160k_guowangtong.py',
                        help='model config path')
    parser.add_argument('--checkpoint',
                        default='../GuoWangTong512_build_20221031/iter_160000.pth',
                        help='model checkpoint path')
    parser.add_argument('--img',
                        default="../tools/dongjin2_0_29568.tif",
